...
class Example
{
    static void Main()
    {
        ...
        // keep the program alive while checking for updates
        Console.ReadKey();
    }
...
class Updater
{
    ...
    static string versionFile = "https://raw.github.com/kalimar94/SimpleUpdater/master/SimpleUpdater/version.ver";
    ...
    static void DownloadUpdates()
    {
        ...
        {
            Console.WriteLine("Downloading updates or whatsoever");
